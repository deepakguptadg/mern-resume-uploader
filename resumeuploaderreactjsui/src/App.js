...
function App() {
  ...
  return (
    <>
        <Box display="flex" justifyContent="center" sx={{ backgroundColor: 'error.light' }} style={{ padding: "10px 0px" }}>
        ...
        <Grid container justifyContent="center">
          ...
          <Grid item xs={5}>
            <Box component="form" sx={{ p: 3 }} noValidate id="resume-form" onSubmit={handleSubmit}>
              ...
              <TextField id="name" name="name" required fullWidth margin='0' label='Name' onChange={(e) => setName(e.target.value)} />

              <TextField id="email" email="email" required fullWidth style={{marginTop: '10px'}} label='Email' onChange={(e) => setEmail(e.target.value)} />
          ...
          <Grid item xs={7} style={{ marginTop: '24px', paddingRight: '24px' }}>
